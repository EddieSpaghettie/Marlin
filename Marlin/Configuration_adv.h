 ...
 */
   ...
   */
  #define PID_FAN_SCALING  //eDs
  #if ENABLED(PID_FAN_SCALING)
    #define PID_FAN_SCALING_ALTERNATIVE_DEFINITION  //eDs
...
>>>>>>> d62119ea5baa8a650bce6bdc6f38520ac228fb02
 * aberrant readings.
 *
 ...
 */
#define HOTEND_IDLE_TIMEOUT  //eDs
#if ENABLED(HOTEND_IDLE_TIMEOUT)
  #define HOTEND_IDLE_TIMEOUT_SEC (10*60)    //eDs was 5*60 (seconds) Time without extruder movement to trigger protection
 ...
 */
#define FAN_KICKSTART_TIME 1000  // (ms)  //eDs
#define FAN_KICKSTART_POWER 180  // 64-255   //eDs
...
#define SENSORLESS_BACKOFF_MM  { 5, 5, 0 }  //eDs (linear=mm, rotational=°) Backoff from endstops before sensorless homing
...
#define SLOWDOWN
#if ENABLED(SLOWDOWN)
  #define SLOWDOWN_DIVISOR 8  //eDs was 2
#endif
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define LCD_TIMEOUT_TO_STATUS 30000   // (ms)   //eDs was 15000

  #if ENABLED(SHOW_BOOTSCREEN)
    #define BOOTSCREEN_TIMEOUT 4000       // (ms) Total Duration to display the boot screen(s)
    #if EITHER(HAS_MARLINUI_U8GLIB, TFT_COLOR_UI)
      //#define BOOT_MARLIN_LOGO_SMALL      //eDs Show a smaller Marlin logo on the Boot Screen (saving lots of flash)
    #endif
  #endif
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define BROWSE_MEDIA_ON_INSERT          //eDs Open the file browser when media is inserted

  #define MEDIA_MENU_AT_TOP               //eDs Force the media menu to be listed on the top of the main menu
  ...
  #define LONG_FILENAME_HOST_SUPPORT      //eDs Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'
 ...
 */
   ...
   */
  //#define DISPLAY_SLEEP_MINUTES 2  //eDs (minutes) Timeout before turning off the screen. Set with M255 S.
 ...
 */
  ...
  #define PROBING_MARGIN_LEFT (PROBING_MARGIN - PROBING_MARGIN )   //eDs Left
  #define PROBING_MARGIN_RIGHT (PROBING_MARGIN - PROBING_MARGIN )   //eDs Right
  #define PROBING_MARGIN_FRONT PROBING_MARGIN  
  #define PROBING_MARGIN_BACK  PROBING_MARGIN  //eDs  Back Large Clips 28 Small Clips 25
 ...
 */
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  45   //eDs
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  42  //eDs
