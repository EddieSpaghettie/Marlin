...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 219.7
  #define DEFAULT_bedKi 40.99
  #define DEFAULT_bedKd 785.1
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  //
  #define DEFAULT_chamberKp 15.5
  #define DEFAULT_chamberKi 0.79
  #define DEFAULT_chamberKd 75.8
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.1, 79.90, 400, 100 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -27.7, +1.77, -2.20 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 15   //eDS was 25
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { PROBING_MARGIN, PROBING_MARGIN, PROBING_MARGIN, PROBING_MARGIN  } // (mm) Left, Front, Right, Back insets
  #define BED_TRAMMING_HEIGHT      0.1        // (mm) Z height of nozzle at leveling points
  #define BED_TRAMMING_Z_HOP       4.0        // (mm) Z height of nozzle between leveling points
  //#define BED_TRAMMING_INCLUDE_CENTER       // Move to the center after the last corner
  #define BED_TRAMMING_USE_PROBE
  #if ENABLED(BED_TRAMMING_USE_PROBE)
    #define BED_TRAMMING_PROBE_TOLERANCE 0.1  // eDs(mm)
